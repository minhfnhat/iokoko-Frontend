    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Exclusive Offers and Updates with Worklife
          </h2>
          <p
          ...
          >
            Subscribe to get the latest updates, product news, and exclusive offers delivered to your inbox. Stay informed about our launch and never miss out on special deals tailored just for you.
          </p>
